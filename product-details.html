...
<head>
    ...
    <!-- Title -->
    <title>Munfirm - Agriculture & Organic Food HTML Template || Product Details</title>
    <!-- Favicon Icon -->
...
<body>
    <div class="page-wrapper">
                   ...
                   <div class="header-top">
                       <div class="row">
                           <div class="col-xl-7 col-lg-6">
                               <div class="top-left">
                                   <ul>
                                        <li><i class="far fa-envelope"></i> <b>Email Us :</b> <a href="mailto:support@gmail.com">support@gmail.com</a></li>
                           ...
                           <div class="col-xl-5 col-lg-6">
                               <div class="top-right text-lg-right">
                                   <ul>
                                        <li><i class="far fa-phone"></i> <b>Call :</b> <a href="callto:+012(345)67899">+012 (345) 678 99</a></li>
                                        <li>
                                    ...
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="dropdown"><a href="#">portfolio</a>
                                            <ul>
                                                ...
                                                <li><a href="portfolio-fluid.html">Portfolio Fluid</a></li>
        ...
        <!-- Page Banner Start -->
        <section class="page-banner text-white py-165 rpy-130" style="background-image: url(assets/images/banner/banner.jpg);">
            <div class="container">
        ...
        <section class="product-details-area pt-130 rpt-100">
            <div class="container">
                    ...
                    <div class="col-lg-6">
                        <div class="product-preview-images rmb-55 wow fadeInLeft delay-0-2s">
                            <a href="assets/images/products/preview1.png">
                                <img src="assets/images/products/preview1.png" alt="Preview">
                            </a>
                            <a href="assets/images/products/preview2.png">
                                <img src="assets/images/products/preview2.png" alt="Preview">
                            </a>
                            <a href="assets/images/products/preview3.png">
                                <img src="assets/images/products/preview3.png" alt="Preview">
                            </a>
                            <a href="assets/images/products/preview4.png">
                                <img src="assets/images/products/preview4.png" alt="Preview">
                            </a>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-6">
                        <div class="product-details-content mb-30 wow fadeInRight delay-0-2s">
                            ...
                            <p>Sorem ipsum dolor sit amet consectetur adipiscing elit do eiusmod tempor incididunt ut labore et dolore magna aliquauis ipsum suspendisse ultrices gravida</p>
                            <span class="price mb-20">55.96</span>
                            <hr>
                            <form action="#" class="add-to-cart mt-40 mb-40">
                                <input type="number" value="2" min="1" max="20" required>
                                <button type="submit" class="theme-btn">Add to Cart <i class="fas fa-angle-double-right"></i></button>
                            </form>
                            <hr>
                            <ul class="category-tags pt-10">
                                <li>
                                    <b>Category</b>
                                    <span>:</span>
                                    <a href="#">Green</a>
                ...
                <ul class="nav nav-tabs product-information-tab pt-35 mb-25">
                    ...
                    <li><a href="#review" data-toggle="tab">Review (05)</a></li>
                </ul>
                <div class="tab-content wow fadeInUp delay-0-2s">
                    <div class="tab-pane active show" id="details">
                        ...
                        <ul class="list-style-one">
                            ...
                            <li>Ultimate Digital Clean-Up Checklist: Are You Prepared For The New Year?</li>
                            <li>How To Roll Out New Features Without Hurting Loyal Users</li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-pane" id="review">
                        <ul class="comment-list">
                            <li>
                                <div class="comment-body">
                                    <div class="author-thumb">
                                        <img src="assets/images/products/review-author1.jpg" alt="Author">
                                    </div>
                                ...
                                <ul class="children">
                                    <li>
                                        <div class="comment-body">
                                            <div class="author-thumb">
                                                <img src="assets/images/products/review-author2.jpg" alt="Author">
                                            </div>
                                            <div class="comment-content">
                                                <div class="name-date">
                            ...
                            <li>
                                <div class="comment-body">
                                    <div class="author-thumb">
                                        <img src="assets/images/products/review-author3.jpg" alt="Author">
                                    </div>
                                    <div class="comment-content">
                                        <div class="name-date">
        ...
        <div class="review-form-area pt-65">
            <div class="container">
                <form id="review-form" class="review-form wow fadeInUp delay-0-2s" name="comment-form" action="#" method="post">
        ...
        <section class="related-product rel z-1 pt-125 rpt-95 pb-130 rpb-100">
            <div class="container">
                ...
                <div class="product-active-two">
                    <div class="product-item wow fadeInUp delay-0-2s">
                        ...
                        <div class="content">
                            ...
                            <h5><a href="product-details.html">Oragic Orange</a></h5>
                            <span class="price">
                                <span>85</span>
                            </span>
                        </div>
                    ...
                    <div class="product-item wow fadeInUp delay-0-4s">
                        ...
                        <div class="content">
                            ...
                            <h5><a href="product-details.html">Organic Brocolli</a></h5>
                            <span class="price">
                                <del>25</del>
                                <span>18</span>
                            </span>
                    ...
                    <div class="product-item wow fadeInUp delay-0-6s">
                        ...
                        <div class="content">
                            ...
                            <h5><a href="product-details.html">Fresh Carrots</a></h5>
                            <span class="price">
                                <del>55</del>
                                <span>36</span>
                            </span>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 order-md-2">
                        <div class="footer-widget about-widget text-center">
                            ...
                            <p>Sit amet consectetur adipiscing elit sed eiusmod tempor incididunt ut labore et dolore magna aliqua. quis ipsum suspendisse ultrices gravida.</p>
                    ...
                    <div class="col-lg-4 col-md-6 order-md-1">
                        <div class="footer-widget menu-widget two-column">
                            ...
                            <ul>
                                ...
                                <li><a href="services.html">Elements</a></li>
                                <li><a href="portfolio-grid.html">Our Projects</a></li>
                                <li><a href="shop-grid.html">Best Products</a></li>
                                <li><a href="farmers.html">Meet Farmers</a></li>
                                <li><a href="service-details.html">Technology</a></li>
                                <li><a href="blog-grid.html">Latest News</a></li>
                                <li><a href="contact.html">Contact Us</a></li>
                                <li><a href="service-details.html">Vegetables</a></li>
